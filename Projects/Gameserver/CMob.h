...
public:
	...
	bool isBagActive(eBag bag) const;
...
void GetCurScore(CMob *mob, STRUCT_AFFECT *affect);

extern CMob pMob[MAX_MOB];
extern TransBonus pTransBonus[5];
extern STRUCT_MOB NPCBase[50];
#endif