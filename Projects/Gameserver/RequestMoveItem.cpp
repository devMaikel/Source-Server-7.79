...
bool CUser::RequestMoveItem(PacketHeader *header)
{
	...
	if (p->DstType == (unsigned char)SlotType::Storage && p->SrcType == (unsigned char)SlotType::Equip || p->DstType == (unsigned char)SlotType::Equip && p->SrcType == (unsigned char)SlotType::Storage)
	{
